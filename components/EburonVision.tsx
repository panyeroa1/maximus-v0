...
const FRAME_ANALYSIS_INTERVAL = 6000; // ms, set to maximize requests within the 10 req/min limit for better responsiveness.
const JPEG_QUALITY = 0.6; // Adjusted for faster uploads while maintaining reasonable image fidelity.
